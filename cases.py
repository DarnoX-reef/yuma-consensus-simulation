...
cases = [
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small lazy vali. (0.1)', 'Small lazier vali. (0.1)'],
    ...
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small eager vali. (0.1)', 'Small lazy vali. (0.1)'],
    ...
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small vali. (0.1)', 'Small vali 2. (0.1)'],
        'base_validator': 'Big vali. (0.8)',
        'reset_bonds': False,
    ...
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small eager-eager vali. (0.1)', 'Small eager-lazy vali. (0.1)'],
    ...
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small eager-lazy vali. (0.1)', 'Small eager-eager vali. (0.1)'],
        'base_validator': 'Small eager-eager vali. (0.1)',
        'reset_bonds': True,
        'reset_bonds_index': 0,
        'reset_bonds_epoch': 21,
    },
    {
        ...
        'validators': ['Big dishonest lazy vali. (0.8)', 'Small eager-eager vali. (0.1)', 'Small eager-eager vali 2. (0.1)'],
        'base_validator': 'Small eager-eager vali. (0.1)',
        'reset_bonds': True,
        'reset_bonds_index': 1,
        'reset_bonds_epoch': 20
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small vali. (0.1/0.2)', 'Small vali 2. (0.1/0.0)'],
        'base_validator': 'Big vali. (0.8)',
        'reset_bonds': False,
    },
    {
        ...
        'validators': ['Big delayed vali. (0.8)', 'Small eager vali. (0.1)', 'Small lazy vali. (0.1)'],
        'base_validator': 'Small eager vali. (0.1)',
        'reset_bonds': False,
    },
    {
    ...
    },
    {
        ...
        'validators': ['Big vali. (0.8)', 'Small dishonest vali. (0.1)', 'Small vali. (0.1)'],
        'base_validator': 'Big vali. (0.8)',
        'reset_bonds': True,
        'reset_bonds_index': 1,
        'reset_bonds_epoch': 20
    ...
    {   
        ...
        'validators': ['Big vali. (0.8)', 'Small vali. (0.1)', 'Small lazy vali. (0.1)'],
        'base_validator': 'Small vali. (0.1)',
        'reset_bonds': False,
    }
]